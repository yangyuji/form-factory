<template>
  <div :class="['comp-content', component.active ? 'active' : '']">
    ...
    <div class="pc-form-item" v-if="deviceType == 'pc'">
      ...
      <el-checkbox-group size="small" class="item-input"
                 :readonly="state == 'readonly'"
                 :disabled="state == 'disabled'"
                 :value="defaultValue">
        <el-checkbox v-if="config.data.type == 'static'"
                   v-for="(item, i) in config.data.options"
                   :key="i" :label="item.value">{{ item.label }}
        </el-checkbox>
      </el-checkbox-group>
